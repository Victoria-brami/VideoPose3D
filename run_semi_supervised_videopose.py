...
# JOB 27
call_ = 'python run.py --causal --batch-size 64 --epochs 200 -lrd 0.98 --warmup 10 --subjects-train vp1 --subset 0.5 --subjects-unlabeled vp5 --checkpoint checkpoint/semi_supervised_27/warm_10_subset_05_vp1234 --keypoints gt_train -arc 3,3,3 --tb_logs logs/causal/semi_supervised_arc_27_subset_05_warm_10_lab_train_4_unlab_6_val_2_length_10000_start_2000_pad_2000 --dataset dad --seq_start 2000 --seq_length 10000 --pad 2000 --export-training-curves --subjects-test vp11,vp12'
